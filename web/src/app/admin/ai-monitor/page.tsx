    ...
    <Card>
      ...
      <CardContent>
        <form method="get" className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <div className="space-y-2"><Label htmlFor="monitor-from">시작일</Label><Input id="monitor-from" name="from" type="date" defaultValue={filters.from} /></div>
          <div className="space-y-2"><Label htmlFor="monitor-to">종료일</Label><Input id="monitor-to" name="to" type="date" defaultValue={filters.to} /></div>
          ...
          <div className="flex items-end"><Button type="submit" className="w-full">조회</Button></div>
