    ...
    <div className="bookgolas-consumer-page min-h-screen bg-[var(--blab-surface-scaffold)] text-[var(--blab-text-primary)]">
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        ...
        {unavailable ? (
          ...
          <>
            <section className="mt-8" aria-labelledby="consumer-account-settings-heading">
              <h2 id="consumer-account-settings-heading" className="sr-only">{t("account.title")}</h2>
              <AccountSettingsClient locale={locale} />
            </section>
