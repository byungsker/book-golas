...
export async function proxy(request: NextRequest) {
  ...
  if (
    (["authenticated-not-found", "bootstrap-network", "deleted-book", "home-book-list", "home-empty-completed", "home-empty-paused", "home-empty-planned", "home-empty-reading", "unauthorized-private-data", "pending", "unavailable"].includes(routeFixture ?? "") || routeFixture?.startsWith("library-") || routeFixture?.startsWith("book-discovery-") || routeFixture?.startsWith("book-lifecycle-") || routeFixture?.startsWith("book-detail-") || routeFixture?.startsWith("progress-") || routeFixture?.startsWith("timer-") || routeFixture?.startsWith("notes-highlights-") || routeFixture?.startsWith("images-ocr-") || routeFixture?.startsWith("review-share-") || routeFixture?.startsWith("calendar-") || routeFixture?.startsWith("charts-goals-") || routeFixture?.startsWith("ai-artifacts-") || routeFixture?.startsWith("ai-consent-") || routeFixture?.startsWith("account-settings-") || routeFixture?.startsWith("account-deletion-") || routeFixture?.startsWith("web-push-") || routeFixture?.startsWith("export-") || routeFixture?.startsWith("recall-")) &&
    isConsumerRoute
  ) {
