...
test("next action prioritizes an unavailable active-user metric", () => {
  const action = getNextAction({
    ...
    reading: { total_records: 43, records_7d: 9, users_with_records: null },
...
test("next action does not treat an unavailable metric as zero", () => {
  const action = getNextAction({
    generated_at: "2026-07-29T04:00:00.000Z",
    period_days: 7,
    source_status: "partial",
    ...
    reading: { total_records: 140, records_7d: 20, users_with_records: 31 },
