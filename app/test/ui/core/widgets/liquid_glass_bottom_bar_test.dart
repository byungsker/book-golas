...
void main() {
  for (final testCase in [
    (
      ...
      width: 393.0,
      labels: const ['홈', '서재', '통계', '캘린더', 'MY'],
      visibleLabels: const ['홈', '서재', '통계', '달력', 'MY'],
    ),
    (
      locale: const Locale('en'),
      width: 393.0,
      labels: const ['Home', 'Library', 'Stats', 'Calendar', 'MY'],
      visibleLabels: const ['Home', 'Lib', 'Stats', 'Cal', 'MY'],
    ),
    (
      locale: const Locale('ko'),
      width: 320.0,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          searchNode.getSemanticsData().hasAction(SemanticsAction.tap),
          isTrue,
        );
        expect(
